...
(function(factory) {
   ...
   * <pre>
   * var NodeContentManagementSystem = require('index'); // See note below*.
   * var xxxSvc = new NodeContentManagementSystem.XxxApi(); // Allocate the API class we're going to use.
   * var yyyModel = new NodeContentManagementSystem.Yyy(); // Construct a model instance.
   ...
   * <pre>
   * var xxxSvc = new NodeContentManagementSystem.XxxApi(); // Allocate the API class we're going to use.
   * var yyy = new NodeContentManagementSystem.Yyy(); // Construct a model instance.
   * yyyModel.someProperty = 'someValue';
   * ...
   * var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
   * ...
